...
// … keep PageLoader, NotFound, ProtectedRoute, AppRoutes, and App() exactly as in your draft …
// Just ensure all merge markers are removed and new routes (TaxCompliance, OwnerPortal, Companies) are kept.
